...
def save_ghsom_cluster_label(data, disease_name):
    os.system('python ./programs/data_processing/save_cluster_with_clustered_label.py --data=%s --name=%s' % (data, disease_name))
...
if os.path.exists('%s/applications/%s' % (current_path, disease_name)):
    ...
    try:
        ...
        save_ghsom_cluster_label(args.data, disease_name)
